            ...
            <div className="container">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div>
                        ...
                        <p className="text-slate-400 max-w-xl">Obviously I'm a UI Developer. UI Developer with over 2+ years of experience. Experienced with all stages of the development.</p>
