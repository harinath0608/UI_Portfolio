        ...
        <section className="relative md:py-24 py-16" id="about">
                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 lg:px-8">
                        <div className="relative">
                            ...
                            <div className="absolute lg:bottom-20 md:bottom-10 bottom-6 ltr:lg:-right-16 rtl:lg:-left-16 ltr:md:-right-8 rtl:md:-left-8 ltr:right-0 rtl:left-0 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
                                <h6 className="font-semibold"> UI Developer </h6>
                    ...
                    <div className="lg:col-span-7">
                        <div className="lg:ms-5">
                            <h3 className="mb-6 md:text-2xl text-xl md:leading-normal leading-normal font-semibold">I'm a Passionate UI Developer </h3>

                            <p className="text-slate-400 max-w-xl text-[15px]">I’m a passionate Web Designer and Developer specializing in UI/UX design and React framework, with 5+ years of experience creating dynamic, user-centric web applications. My mission is to deliver intuitive, visually stunning designs that elevate user experiences. Let’s collaborate to bring your vision to life with cutting-edge solutions!</p>
            ...
            <div className="container md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto text-[15px]">Obviously I'm a Web Designer. Web Developer with over 5 years of experience. Experienced with all stages of the development and design.</p>
                </div>
